...
public class SunshineWatchFaceService extends CanvasWatchFaceService {
    ...
    private class Engine extends CanvasWatchFaceService.Engine implements DataApi.DataListener,
        ...
        public void onDraw(Canvas canvas, Rect bounds) {
            ...
            float timeTextLength = mTextTimePaint.measureText(timeText);
            float xOffsetTime = timeTextLength / 2;
            ...
            String weekDay = dateTime.dayOfWeek().getAsShortText();
            String dayOfMonth = dateTime.dayOfMonth().getAsShortText();
            String year = dateTime.year().getAsString();
            String dateText = weekDay + ", " + month + " " + dayOfMonth + " " + year;
